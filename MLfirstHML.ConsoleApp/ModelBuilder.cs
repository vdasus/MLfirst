...
namespace MLfirstHML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\REPO\_Learn\ML\MLfirstH\data\wikiDetoxAnnotated40kRows.tsv";
        private static string MODEL_FILEPATH = @"../../../../MLfirstHML.Model/MLModel.zip";
